...
export default function Login() {
  return (
    ...
    <form className="p-3 md:flex-wrap sm:flex-wrap flex ">
      ...
      <input type="email" required className="text-center focus:outline-none  border-none border-5 border-black text-black p-1 m-1" id="email" name="email" placeholder="enter your email"  />
    </form>
    </div>
    </div>
    ...
    <div>
    <form className="p-3 md:flex-wrap sm:flex-wrap flex ">
     <label className="mt-3" htmlFor="password"><h1><b>Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></h1></label><br />
    ...
    <Link href="/"><button type="submit" className="border border-1 border-black hover:bg-black hover:text-white mb-5 px-5 p-2 rounded-md mx-5" type="submit"><b>Login</b></button></Link>
    </div>
